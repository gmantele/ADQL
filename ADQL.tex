...
\begin{itemize}
        ...
        \begin{description}
            \item[Arguments]:
                \begin{description}
                    \item[x] double
                \end{description}
            \item[Return datatype] double
        \end{description}

    \item \textbf{ceiling(x)}
    ...
    \item \textbf{rand(x)}
        ...
        \begin{description}
            \item[Arguments]:
                \begin{description}
                    \item[x] double \textit{(optional)}
                \end{description}
            \item[Return datatype] double
        \end{description}

    \item \textbf{round(x,n)}
        ...
        \begin{description}
            \item[Arguments]:
                \begin{description}
                    \item[x] double
                    \item[n] integer \textit{(optional ; default: 0)}
                \end{description}
            \item[Return datatype] double
        \end{description}

    \item \textbf{truncate(x,n)}
