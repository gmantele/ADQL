![ADQL version](https://img.shields.io/badge/ADQL-WD--2.2-lightgrey.svg)
...
An HTML version of the BNF can also be generated. It is generated from
[adql-bnf.txt](bnf/adql-bnf.txt) by the Makefile target named `bnf`. This latter
uses the Perl script [bnf2html.pl](bnf/bnf2html.pl), originally coming from
...
_Note that currently, a generated version ([adql-bnf.html](bnf/adql-bnf.html))
is visible as demonstration in this repository. As a generated product, it will
be removed in the future and will be later automatically generated by a GitHub
workflow or manually with `make bnf`._
